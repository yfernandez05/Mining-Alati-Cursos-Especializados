...
<style>
    ...
    /* .slider_home{
        background-image: url(../images/operacionesmineras.jpg);
    } */
</style>
@endsection
        ...
        <div class="container-fluid col-11 content_banner__home m-auto ">
            <div class="row justify-content-center">
                ...
                <div class="col-12 col-md-6 col-lg-7 col-xl-7 text-white text-info_banner">                    
                    ...
                    <div data-aos="fade-up" class="cont-white d-none d-md-block text-uppercase"><h3 class="text-primary" style="text-shadow: none;">DERECHO MINERO</h3></div>
                    ...
                    <h3 data-aos="fade-up" id="" class="d-block d-md-none text-uppercase">
                        CURSOS ESPECIALIZADOS EN DERECHO MINERO
                    </h3>
                </div>
                    ...
                    <div class="col-12 col-md-12 col-lg-12 align-self-center p-0">
                        <?php 
                            $cursos = [
                                ...
                                [
                                    'nombre' => 'Derechos de la construcciòn',
                                    'codigoProducto' => 189,
                                ],
                                [
                                    'nombre' => 'Formalización de la pequeña minería',
                                    'codigoProducto' => 190,
                                ]
                            ];
                        ?>
        ...
        <div class="container">
            <div class="col-12 internal-cursos" data-aos="zoom-out">
                    <?php
                        $coursesMetalurgia = [
                            [
                                'courseDescription' => 'Derecho minero',
                                'courseUrl' => 'files/derechominero/derecho-minero.pdf',
                            ],
                            [
                                'courseDescription' => 'Legislación Minera',
                                'courseUrl' => 'files/derechominero/legislacion-minera.pdf',
                            ],
                            [
                                'courseDescription' => 'Derechos de la construcción',
                                'courseUrl' => 'files/derechominero/derechos-de-la-construccion.pdf',
                            ],
                            [
                                'courseDescription' => 'Formalización de la pequeña minería',
                                'courseUrl' => 'files/derechominero/formalizacion-de-la-pequena-mineria.pdf',
                            ]                           
                        ];
                    ?>
