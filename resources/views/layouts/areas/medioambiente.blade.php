        ...
        <div class="container-fluid col-11 content_banner__home m-auto ">
            <div class="row justify-content-center">
                ...
                <div class="col-12 col-md-6 col-lg-7 col-xl-7 text-white text-info_banner">                    
                    ...
                    <div data-aos="fade-up" class="cont-white d-none d-md-block text-uppercase"><h3 class="text-primary" style="text-shadow: none;">MEDIO AMBIENTE</h3></div>
                ...
                <div class="col-12 col-md-6 col-lg-5 col-xl-4 justify-content-center cont-form" data-aos="fade-left"  data-aos-duration="800">
                    <div class="col-12 col-md-12 col-lg-12 align-self-center p-0">
                        <?php 
                            $cursos = [
                                [
                                    'nombre' => 'Evaluación de Impacto Ambiental en Minería',
                                    'codigoProducto' => 66,
                                  ],
                                  [
                                    'nombre' => 'Técnicas analítica para estudio de la contaminación, minero – ambiental',
                                    'codigoProducto' => 67,
                                  ],
                                  [
                                    'nombre' => 'Suelos y Contaminación',
                                    'codigoProducto' => 68,
                                  ],
                                  [
                                    'nombre' => 'Remediación Ambiental',
                                    'codigoProducto' => 69,
                                  ],
                                  [
                                    'nombre' => 'Minerales y Salud Humana',
                                    'codigoProducto' => 70,
                                  ],
                                  [
                                    'nombre' => 'Interacción con el sub suelo: almacenamiento de residuos, CO2 y gas.',
                                    'codigoProducto' => 71,
                                  ],
                                  [
                                    'nombre' => 'Diseño de Proyectos con Enfoque en Sostenibilidad',
                                    'codigoProducto' => 186,
                                  ],
                            ];
                        ?>
        ...
        <div class="container">
            <div class="col-12 internal-cursos" data-aos="zoom-out">
                    <?php
                        $coursesMetalurgia = [
                            [
                                'courseDescription' => 'Evaluación de Impacto Ambiental en Minería',
                                'courseUrl' => 'files/medioambiente/evaluacion-de-impacto-ambiental-en-mineria.pdf',
                              ],
                              [
                                'courseDescription' => 'Técnicas analítica para estudio de la contaminación, minero – ambiental',
                                'courseUrl' => 'files/medioambiente/tecnicas-analitica-para-estudio-de-la-contaminacion-minero-ambiental.pdf',
                              ],
                              [
                                'courseDescription' => 'Suelos y Contaminación',
                                'courseUrl' => 'files/medioambiente/suelos-y-contaminacion.pdf',
                              ],
                              [
                                'courseDescription' => 'Remediación Ambiental',
                                'courseUrl' => 'files/medioambiente/remediacion-ambiental.pdf',
                              ],
                              [
                                'courseDescription' => 'Minerales y Salud Humana',
                                'courseUrl' => 'files/medioambiente/minerales-y-salud-humana.pdf',
                              ],
                              [
                                'courseDescription' => 'Interacción con el sub suelo: almacenamiento de residuos, CO2 y gas.',
                                'courseUrl' => 'files/medioambiente/interaccion-con-el-sub-suelo-almacenamiento-de-residuos-co2-y-gas.pdf',
                              ],
                              [
                                'courseDescription' => 'Diseño de Proyectos con Enfoque en Sostenibilidad',
                                'courseUrl' => 'files/medioambiente/diseno-de-proyectos-con-enfoque-en-sostenibilidad.pdf',
                              ],
                        ];
                    ?>
